...
export const DocumentTextIcon = ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className || "w-6 h-6"}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M9 12h.01M15 12h.01M10.5 16.5h3M15.75 10.5h3m-6.75 3h3m-3.75 3h3m-3.75 3h3m3-13.5h-9a2.25 2.25 0 00-2.25 2.25v13.5A2.25 2.25 0 007.5 21h9a2.25 2.25 0 002.25-2.25V9.375c0-.621-.258-1.223-.732-1.666l-4.5-4.5A2.25 2.25 0 0011.25 2.25H7.5A2.25 2.25 0 005.25 4.5v.375m6 5.25-2.25-2.25-2.25 2.25m6-5.25v4.5A2.25 2.25 0 0113.5 15h-3a2.25 2.25 0 01-2.25-2.25V4.5m6 5.25h.75" />
    </svg>
);
...
export const ClipboardDocumentListIcon = ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className || "w-6 h-6"}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M9 12h.01M15 12h.01M10.5 16.5h3M15.75 10.5h3m-6.75 3h3m-3.75 3h3m-3.75 3h3m3-13.5h-9a2.25 2.25 0 00-2.25 2.25v13.5A2.25 2.25 0 007.5 21h9a2.25 2.25 0 002.25-2.25V9.375c0-.621-.258-1.223-.732-1.666l-4.5-4.5A2.25 2.25 0 0011.25 2.25H7.5A2.25 2.25 0 005.25 4.5v.375" />
    </svg>
);

export const ArrowPathIcon = ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className || "w-6 h-6"}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M16.023 9.348h4.992v-.001M2.985 19.644v-4.992m0 0h4.992m-4.993 0l3.181 3.183a8.25 8.25 0 0011.667 0l3.181-3.183m-11.667 0a8.25 8.25 0 0111.667 0l3.181 3.183m0 0V19.644" />
    </svg>
);
...
export const BackBodyIcon = ({ className }: { className?: string }) => <svg className={className || "w-8 h-8"} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M16 4.5c0 2-1.5 4.5-4 4.5S8 6.5 8 4.5C8 2.5 9.5 2 12 2s4 .5 4 2.5z" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path><path d="M8 9.5v8c0 1.105.895 2 2 2h4c1.105 0 2-.895 2-2v-8C16.5 11 14 12.5 12 12.5S7.5 11 8 9.5z" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path></svg>;
export const PelvisBodyIcon = ({ className }: { className?: string }) => <svg className={className || "w-8 h-8"} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M5.075 5.075C3.328 6.822 2.809 9.36 3.32 11.66c.862 3.88 3.652 6.67 7.53 7.53 2.3.51 4.838-.008 6.585-1.756 2.05-2.05 2.05-5.377 0-7.425C15.488 8.058 12.062 7.5 9 7.5c-1.996 0-3.896.39-5.65.925" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path></svg>;
export const LimbsBodyIcon = ({ className }: { className?: string }) => <svg className={className || "w-8 h-8"} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M10 3L6 7v10l4 4M14 3l4 4v10l-4 4M6 7h12M6 17h12" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path></svg>;
export const SkinBodyIcon = ({ className }: { className?: string }) => <svg className={className || "w-8 h-8"} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M15.586 19.414L12 15.828l-3.586 3.586a2 2 0 01-2.828-2.828L9.172 13l-3.586-3.586a2 2 0 112.828-2.828L12 10.172l3.586-3.586a2 2 0 112.828 2.828L14.828 13l3.586 3.586a2 2 0 01-2.828 2.828z" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path><path d="M3 12a9 9 0 1018 0 9 9 0 00-18 0z" stroke="currentColor" strokeWidth="1.5"></path></svg>;
export const UrinaryBodyIcon = ({ className }: { className?: string }) => <svg className={className || "w-8 h-8"} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M7.5 12.5c0-2.485 2.015-4.5 4.5-4.5s4.5 2.015 4.5 4.5c0 1.956-1.402 3.73-3.498 4.335" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path><path d="M11 16.833V20.5a1.5 1.5 0 003 0v-3.667" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path><path d="M12 2C6.477 2 2 6.477 2 12s4.477 10 10 10 10-4.477 10-10S17.523 2 12 2z" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path></svg>;
export const BodyIcon = ({ className }: { className?: string }) => <svg className={className || "w-8 h-8"} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M12 2a2 2 0 100 4 2 2 0 000-4zM7 21v-7l-2-2v-3h14v3l-2 2v7" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path></svg>;
...
export const Cog6ToothIcon = ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className || "w-6 h-6"}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M9.594 3.94c.09-.542.56-.94 1.11-.94h2.593c.55 0 1.02.398 1.11.94l.213 1.281c.063.374.26.716.54.962l.958.836c.446.39.492 1.08.116 1.522l-.964 1.123c-.28.326-.478.75-.54 1.123l-.213 1.281c-.09.543-.56.941-1.11.941h-2.594c-.55 0-1.02-.398-1.11-.941l-.213-1.281c-.063-.374-.26-.716-.54-.962l-.958-.836c-.377-.442-.33-1.132.116-1.522l.964-1.123c.28-.326.478.75.54-1.123l.213-1.281Z" />
...
export const ChatBubbleLeftRightIcon = ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className || "w-6 h-6"}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M20.25 8.511c.884.284 1.5 1.128 1.5 2.097v4.286c0 1.136-.847 2.1-1.98 2.193-.34.027-.68.052-1.02.072v3.091l-3-3c-1.355 0-2.697-.056-4.024-.166-.37-.03-.733-.078-1.092-.141M16.5 7.5c.221 0 .441.005.657.014C18.412 7.6 19.5 8.717 19.5 10.2v4.266c0 1.258-1.096 2.3-2.5 2.443-1.08.11-2.186.191-3.314.234M4.5 8.25c0-1.657 1.343-3 3-3h8.25c1.657 0 3 1.343 3 3v4.5c0 1.657-1.343 3-3 3h-2.126l-3.375 3.375v-3.375H7.5c-1.657 0-3-1.343-3-3v-4.5z" />
    </svg>
);
